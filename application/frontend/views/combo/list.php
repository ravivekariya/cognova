...
$attributes = array('class' => 'frm_add_record form-horizontal', 'id' => 'frm_list_record', 'name' => 'frm_list_record');
    ...
    <div class="span6 text-left">
     ...
     <div class="span6 text-right">     
 		<select class="required span6" name="slt_combo_case" id="slt_combo_case" >
        	<?php echo $this->Page->generateComboByTable("combo_master","combo_case","combo_case","","where status='ACTIVE'",$combo_case,"Select Combo Case","GROUP BY combo_case"); ?>
        </select>
