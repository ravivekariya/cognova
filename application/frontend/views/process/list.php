...
$attributes = array('class' => 'frm_add_record form-horizontal', 'id' => 'frm_list_record', 'name' => 'frm_search_module');
echo form_open('c=Process', $attributes);
?>
    ...
    <div class="span12">
        <table width="100%" cellpadding="5" cellspacing="5" border="0" class="table table-striped table-bordered table-hover dataTable" id="pagelist_center">
            ...
            <tbody>
                ...
                {
                    foreach($rsProcess as $arrRecord)
                    {
                        $strEditLink	=	"index.php?c=Process&m=AddProcess&action=E&id=".$arrRecord['id'];
                        echo '<tr>';
