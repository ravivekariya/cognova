...
$attributes = array('class' => 'frm_add_record form-horizontal', 'id' => 'frm_add_color', 'name' => 'frm_add_color');
echo form_open('c=itemcolor&m=Save', $attributes);
?>
<div class="page-header position-relative">
    <h1>Add Item Color</h1>
	<?php
		echo $strMessage;
	?>
</div>
...
<input type="hidden" name="item_color_id" value="<?php echo $id; ?>" id="item_color_id" />
    ...
    <div class="span10">
        <fieldset>
            ...
            <div class="control-group">
                <label for="form-field-1" class="control-label">Color Name <span class="red">*</span></label>
                <div class="controls">
                    <input type="text" id="txt_color_name" name="txt_color_name" class="required span6" value="<?php echo $rsEdit->item_color_name; ?>" />
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="txt_color_code" name="txt_color_code" class="required span6" value="<?php echo $rsEdit->item_color_code; ?>" />
                </div>
            </div>
